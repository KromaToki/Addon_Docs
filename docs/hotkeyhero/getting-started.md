...
- HotkeyHero treats Blender-default keys as addressable items. A newly detected set of deleted defaults is presented for normalization (undelete) rather than changed silently during scanning.
