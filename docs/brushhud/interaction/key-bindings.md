...
- The exact snap increments are defined on the [Snap Settings](./snap-settings.md) page.

## Practical Advice

New users usually only need to decide three things at first:

1. the main Trigger Key,
2. whether Tap to Toggle should be enabled (toggle it on since both modes work when on)
3. which modifier should act as the Sensitivity key.
